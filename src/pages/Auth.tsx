        ...
        <Card className="glass-effect shadow-2xl border-white/10">
          ...
          <CardContent className="space-y-3 relative">
            ...
            <Button
              ...
              disabled={isLoading !== null}
              className="w-full h-14 text-base bg-[#FC3F1D] hover:bg-[#DD3619] text-white border-0 shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
              {isLoading === 'yandex' ? (
                <Icon name="Loader2" size={20} className="mr-3 animate-spin" />
              ) : (
                <svg className="mr-3 h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm4.4 19.1h-2.5l-3.7-6.5H9v6.5H7V4.9h4.1c2.7 0 4.4 1.5 4.4 3.9 0 2-1.2 3.2-2.7 3.6l3.6 6.7zM9 6.6v4.7h1.7c1.4 0 2.3-.8 2.3-2.4s-.9-2.3-2.3-2.3H9z"/>
                </svg>
              )}
              Войти через Яндекс
            </Button>
